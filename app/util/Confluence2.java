...
public class Confluence2 {
    ...
    /**
     * returns all the {@link org.codehaus.swizzle.confluence.SpaceSummary} instances that the current user can see.
     */
    ...
    /**
     * return a list of {@link javax.naming.directory.SearchResult}s which match a given search query (including pages and other content types). This is the same as a performing a parameterised search (see below) with an
     * empty parameter map.
     */
    public List search(String query, int maxResults) throws SwizzleException, ConfluenceException {
        ...
        return toList(vector, javax.naming.directory.SearchResult.class);
    }

    /**
     * Returns a list of {@link javax.naming.directory.SearchResult}s like the previous search, but you can optionally limit your search by adding parameters to the parameter map. If you do not include a parameter, the
